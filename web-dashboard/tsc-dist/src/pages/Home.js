...
function Home() {
    var _a = (0, AuthContext_1.useAuth)(), token = _a.token, user = _a.user;
    ...
    return (<div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50">
      ...
      <main className="pt-24 px-8 max-w-7xl mx-auto space-y-28">
        ...
        <section className="flex flex-col md:flex-row items-center gap-10">
          ...
          <img src="https://cdn-icons-png.flaticon.com/512/3281/3281306.png" alt="Demand Forecasting" className="w-80 h-auto object-contain rounded-xl shadow"/>
        </section>
        ...
        <section className="flex flex-col md:flex-row-reverse items-center gap-10">
          ...
          <img src="https://cdn-icons-png.flaticon.com/512/2991/2991045.png" alt="Spoilage Simulation" className="w-80 h-auto object-contain rounded-xl shadow"/>
        </section>
        ...
        <section className="flex flex-col md:flex-row items-center gap-10">
          ...
          <img src="https://cdn-icons-png.flaticon.com/512/4363/4363708.png" alt="Smart Distribution" className="w-80 h-auto object-contain rounded-xl shadow"/>
        </section>
