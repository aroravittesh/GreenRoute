...
//       const result = await axios.get("http://54.197.3.23:5786/api/model-c/run");
//       // Update metrics
//       setMetrics({
...
//       });
//       // Update chart
//       setChartUrl(`http://54.197.3.23:5786/api/model-c/image?ts=${Date.now()}`);
//       // Get CSV results
//       const csv = await axios.get(
//         "http://54.197.3.23:5786/api/model-c/predictions"
//       );
...
function DistributionPlanner() {
    ...
    (0, react_1.useEffect)(function () {
        ...
        if (savedCsv && savedTimestamp) {
            ...
            setChartUrl("http://54.197.3.23:5786/api/model-c/image?ts=".concat(savedTimestamp));
        }
    }, []);
    var runOptimizer = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 4, , 5]);
                    return [4 /*yield*/, axios_1.default.get("http://54.197.3.23:5786/api/model-c/run")];
                case 2:
                    _a.sent();
                    timestamp = Date.now();
                    setChartUrl("http://54.197.3.23:5786/api/model-c/image?ts=".concat(timestamp));
                    localStorage.setItem(STORAGE_KEY_TIMESTAMP, timestamp.toString());
                    return [4 /*yield*/, axios_1.default.get("http://54.197.3.23:5786/api/model-c/predictions")];
                case 3:
                    csv = _a.sent();
